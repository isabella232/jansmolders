var jsonData = {
  "en": {
    "nav": {
      "labels": ['Ons Verhaal', 'Onze Werkwijze', 'projecten', 'contact']
    },
    "homepage": {
        "header": {
        ...
        "content": {
          ...
          "about" : {
            "employees": [
                {
                  "title": "Niek van Gent",
                  "description": "10 jaar kennis en ervaring in de beursindustrie gecombineerd met 10 jaar sales en marketing ervaring vormt onze basis. ",
                  "image": {
          ...
          "fundament" : {
            "title": "ONS FUNDAMENT",
            "description": "10 jaar kennis en ervaring in de beursindustrie gecombineerd met 10 jaar sales en marketing ervaring vormt onze basis. Hierdoor kunnen wij als geen ander unieke beursconcepten bedenken die zorgen voor de hoogste return on investment. Wie we zijn?",
              "image": {
                  "src" :"https://images-na.ssl-images-amazon.com/images/I/81VStYnDGrL.jpg",
                  "alt": "Jan Maas"
              }
                ...
                "images": [
                    {
                        "title": "ONZE VISIE",
                        "description": "Lorem Ipsum.",
                        "src": "https://i.pinimg.com/originals/76/b8/a7/76b8a7f9c9048e23c3e19e288f15212f.jpg"
        ...
        "footer": {
            "title": "De koffie staat altijd klaar",
            "headers": [
                "Schrijf Ons",
                "Bel Ons",
                "Bezoek Ons"
            ...
            "call":[
                {
                    "links": [
                        ...
                        {
                            "title": "Niek van Gent",
                            "phone": "+31 6 41 78 15 81"
                        }
                    ]
                }
            ],
            "visit": {
                "description":"Garnizoenweg 3\n" +
                        "Building A\n" +
                        "5928 NA Venlo\n" +
                        "The Netherlands"
            },
            "copyright": "Copyright 2018, Expo-Mate - None of the Images on the website are owned or affiliated with Expo-mate and are copyrighted by their respectful owners."
        }
    }
  }
};
